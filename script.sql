-- drop database projetoIntegra;
 create database projetoIntegra;
...
insert into service(description) values ("Formatação de Sistema");
insert into service(description) values ("Limpeza de Computadores");
insert into service(description) values ("Montagem de Computadores");
insert into service(description) values ("Troca de Componentes");
insert into service(description) values ("Criação de Sites");
insert into service(description) values ("Criação de Aplicativos Android/IOS");
insert into service(description) values ("Criação de Aplicativos Desktop");
insert into service(description) values ("Design de Banners");
insert into service(description) values ("Design de Logos");
